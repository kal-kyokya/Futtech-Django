...
const About = () => {
	...
	<div id="page-top">
		...
		<p>I acquired the domain 'kalkyokya.tech' in July 2024.<br />
		    ...
		    This immediately gave rise to a new challenge; Cross-Origin Resource Sharing (<a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/CORS" target="_blank" rel="noopener noreferrer">CORS</a>). It took another two days to go through the documentation, stackoverflow and YouTube tutorials to understand the bugs.<br /><br />
		    <em>
		...
		<p>I am willing to put in long hours to master full-cycle software development.<br />
		    Thanks to my foundational training with <a href="https://www.alxafrica.com/" target="_blank" rel="noopener noreferrer">
								ALX Africa
